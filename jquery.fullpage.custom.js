...
(function(global, factory) {
  ...
  $.fn.fullpage = function(options) {
    ...
    */
    ...
    /**
     * Sets the value for the given attribute type from the `data-` attribute with the same suffix
    ...
    /**
     * Sets the style value for the given background image from the `data-` attribute
     * ie: data-background-image ==> style="background-image: url(${attribute})""
     */
    function setDivBackgroundImage(element, attribute) {
      element
        .css(attribute, 'url(' + element.data(attribute) + ')')
        .removeAttr('data-' + attribute);
    }

    /**
     * Lazy loads image, background-image, video and audio elements.
     */
    function lazyLoad(destiny) {
      ...
      var element;
      var divType = 'background-image';

      // check if background-image on panel itself
      var attribute = panel.attr('data-' + divType);
      if (typeof attribute !== 'undefined' && attribute) {
        setDivBackgroundImage(panel, divType);
      }

      panel.find('div[data-background-image]').each(function() {
        element = $(this);

        var attribute = element.attr('data-' + divType);
        if (typeof attribute !== 'undefined' && attribute) {
          setDivBackgroundImage(element, divType);
        }
      });
    ...
    function destroyStructure() {
      ...
      container.find('div[data-background-image]').each(function() {
        setDivBackgroundImage($(this), 'background-image');
      });
